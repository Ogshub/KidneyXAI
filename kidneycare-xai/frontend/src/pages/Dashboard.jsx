...
export const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[65vh] flex flex-col items-center justify-center gap-3">
        <Spinner size="lg" />
        <p className="text-slate-500 text-sm font-medium">Aggregating kidney health intelligence...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-gradient-to-r from-teal-900 to-slate-900 text-white p-6 sm:p-8 rounded-3xl shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link to="/tracker">
            <Button size="md" variant="secondary" icon={PlusCircle} className="bg-white/10 hover:bg-white/20 text-white border-white/20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <Card className="border-l-4 border-l-teal-600">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500">model index</span>
          </div>
          <div className="mt-3 text-xs text-slate-500 flex items-center justify-between border-t border-slate-100 pt-3">
            <span>{data?.prediction || 'Awaiting evaluation'}</span>
            <Link to="/assessment" className="text-teal-600 hover:text-teal-700 font-semibold inline-flex items-center gap-1">
        ...
        <Card className="border-l-4 border-l-emerald-600">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Lifestyle Score</span>
          ...
          <div className="mt-3 text-xs text-slate-500 flex items-center justify-between border-t border-slate-100 pt-3">
            ...
            <Link to="/tracker" className="text-teal-600 hover:text-teal-700 font-semibold inline-flex items-center gap-1">
        ...
        <Card className="border-l-4 border-l-sky-500">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Hydration (Today)</span>
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500">goal: 2.5 L</span>
          </div>
          <div className="mt-3 text-xs text-slate-500 flex items-center justify-between border-t border-slate-100 pt-3">
        ...
        <Card className="border-l-4 border-l-violet-500">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Exercise & Sleep</span>
          ...
          <div className="flex items-baseline gap-3">
            ...
            <div>
              ...
              <span className="text-xs text-slate-500 ml-1">hrs sleep</span>
            </div>
          </div>
          <div className="mt-3 text-xs text-slate-500 flex items-center justify-between border-t border-slate-100 pt-3">
            <span>Daily recovery</span>
            <Link to="/tracker" className="text-violet-600 hover:text-violet-700 font-semibold inline-flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card
          ...
          icon={TrendingUp}
          action={
            <Link to="/history" className="text-xs font-medium text-teal-600 hover:text-teal-700 inline-flex items-center gap-1">
        ...
        <Card
          ...
          icon={Activity}
          action={
            <Link to="/tracker" className="text-xs font-medium text-teal-600 hover:text-teal-700 inline-flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          {data?.topContributors && data.topContributors.length > 0 ? (
            ...
            <div className="h-64 flex flex-col items-center justify-center text-center p-6 bg-slate-50/60 rounded-xl border border-dashed border-slate-200">
              ...
              <p className="text-sm font-medium text-slate-700">No SHAP breakdown available yet.</p>
        ...
        <Card
          ...
          icon={Sparkles}
          action={
            <Link to="/recommendations" className="text-xs font-medium text-teal-600 hover:text-teal-700 inline-flex items-center gap-1">
        ...
        >
          {data?.recentRecommendations && data.recentRecommendations.length > 0 ? (
              ...
              {data.recentRecommendations.slice(0, 4).map((rec) => {
                ...
                return (
                  ...
                  >
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-2 mt-2">
                            ...
                            <button
                              ...
                              className="text-[11px] text-teal-700 hover:text-teal-800 font-medium inline-flex items-center gap-1 ml-1 cursor-pointer"
                            >
                    ...
                    {isExpanded && (
                      <div className="mt-3 pt-2.5 border-t border-slate-200/70 text-xs text-slate-600 bg-white/70 p-2.5 rounded-lg">
                        <strong className="text-slate-800 block mb-0.5">Trigger Rationale:</strong>
            ...
            <div className="h-64 flex flex-col items-center justify-center text-center p-6 bg-slate-50/60 rounded-xl border border-dashed border-slate-200">
              ...
              <p className="text-sm font-medium text-slate-700">No recommendations generated yet.</p>
              <p className="text-xs text-slate-500 max-w-xs mt-1">
